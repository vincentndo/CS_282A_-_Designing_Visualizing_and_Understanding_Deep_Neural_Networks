canvasWebpackJsonp([115],{"1Y62h3eT2s":function(e,t,r){"use strict"
...
if(!("require"in window)){var o=r("mOY9BNujNR"),d={jquery:function(){return o},i18nObj:function(){return new Promise(function(e){e()}).then(r.bind(null,"36QOWIB4+W"))},underscore:function(){return new Promise(function(e){e()}).then(r.bind(null,"iBw8ZGM6v8"))},"jsx/course_wizard/ListItems":function(){return r.e(22).then(r.bind(null,"bzx8AghjTc"))}},u=function(e){if(e in d)return d[e]()
...
Promise.all(e.map(u)).then(function(e){t&&t.apply(void 0,(0,i.default)(e))})}}},GfsekNpohF:function(e,t,r){"use strict"
Object.defineProperty(t,"__esModule",{value:!0})
t.default=void 0
...
var n=a(r("BiqnZq/6bY")),i=r("9HcErlrWg/"),o=a(r("o5O6uYWuQQ")),d=a(r("GfsekNpohF")),u=r("VfnPWtOxDI"),l=(0,n.default)({},u.baseVariables,{colors:d.default})
t.variables=l
var c=(0,i.registerTheme)({key:o.default.CANVAS_HIGH_CONTRAST,immutable:!1,description:"This theme meets WCAG 2.0 AA rules for color contrast.",variables:l})
...
var n=a(r("BiqnZq/6bY")),i=r("9HcErlrWg/"),o=a(r("o5O6uYWuQQ")),d=a(r("aqnp7+ruGG")),u=a(r("T7MAAnqGwx")),l=a(r("LNmG0vr5r2")),c=a(r("omxlES1/1+")),s=a(r("iYPl8rblUq")),f=a(r("1Y62h3eT2s")),b=a(r("eoBv0CU+Ie")),m=a(r("hog7jFXZ8p")),g=a(r("I/UqtyMvZw")),v=a(r("L/Ji3F6A4a")),_=o.default.CANVAS
t.key=_
var h={borders:d.default,colors:u.default,transitions:l.default,typography:c.default,spacing:s.default,forms:f.default,media:b.default,breakpoints:m.default,shadows:g.default,stacking:v.default}
t.baseVariables=h
var p={"ic-brand-primary":u.default.textBrand,"ic-brand-font-color-dark":u.default.textDarkest,"ic-link-color":u.default.textLink,"ic-link-decoration":"none","ic-brand-button--primary-bgd":u.default.backgroundBrand,"ic-brand-button--primary-text":u.default.textLightest,"ic-brand-button--secondary-bgd":u.default.backgroundDarkest,"ic-brand-button--secondary-text":u.default.textLightest,"ic-brand-global-nav-bgd":u.default.backgroundBrandSecondary,"ic-global-nav-link-hover":u.default.backgroundDarkest,"ic-brand-global-nav-ic-icon-svg-fill":u.default.textLightest,"ic-brand-global-nav-ic-icon-svg-fill--active":u.default.textBrand,"ic-brand-global-nav-menu-item__text-color":u.default.textLightest,"ic-brand-global-nav-menu-item__text-color--active":u.default.textBrand}
t.brandVariables=p
var A=(0,n.default)({},h,p)
t.variables=A
var E=(0,i.registerTheme)({key:o.default.CANVAS,variables:A})
t.default=E},"aqnp7+ruGG":function(e,t,r){"use strict"
Object.defineProperty(t,"__esModule",{value:!0})
t.default=void 0
...
var a=u(r("Dd8wAUAVWO")),n=u(r("VfnPWtOxDI")),i=u(r("Qwg4WMdjCp")),o=u(r("PJh52PO9+b")),d=u(r("1IKDY5pCFs"))
r("AueD11u85v")
function u(e){return e&&e.__esModule?e:{default:e}}(0,o.default)().locale(ENV.MOMENT_LOCALE)
if("undefined"!=typeof ENV){ENV.TIMEZONE&&d.default.changeZone(ENV.TIMEZONE)
ENV.CONTEXT_TIMEZONE&&d.default.preload(ENV.CONTEXT_TIMEZONE)
ENV.BIGEASY_LOCALE&&d.default.changeLocale(ENV.BIGEASY_LOCALE,ENV.MOMENT_LOCALE)}if(ENV.use_high_contrast)i.default.use()
else{var l=window.CANVAS_ACTIVE_BRAND_VARIABLES||{},c={}
"test"===window.INST.environment&&(c={transitions:{duration:"0ms"}})
n.default.use({overrides:(0,a.default)({},c,l)})}if("test"===window.INST.environment){window.__CANVAS_IN_FLIGHT_XHR_REQUESTS__=0
...
Object.defineProperty(t,"__esModule",{value:!0})
t.default=void 0
var a=8,n=16,i=30,o=48,d=62,u=75,l=Object.freeze({xxSmall:"".concat(a,"em"),xSmall:"".concat(n,"em"),small:"".concat(i,"em"),medium:"".concat(o,"em"),large:"".concat(d,"em"),xLarge:"".concat(u,"em"),maxWidth:"".concat(d-.0625,"em")})
t.default=l},iYPl8rblUq:function(e,t,r){"use strict"
Object.defineProperty(t,"__esModule",{value:!0})
t.default=void 0
...
//# sourceMappingURL=appBootstrap.bundle-93c00351a3.js.115-93c00351a3.sourcemap