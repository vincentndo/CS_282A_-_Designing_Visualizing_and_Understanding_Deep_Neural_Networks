...
zip -r assignment4submission.zip "Part01_Policy-Gradients.ipynb" "Part02_Deep-Q-Networks.ipynb" "data_pg/" "data_dqn/" "train_dqn.py" "train_pg.py" "dqn.py" "logz.py" "dqn_utils.py" "atari_wrappers.py" "files/"
